...
public class AOAItems {
    ...
    public static final Item THE_WATCHER = registerItem("the_watcher",
            new Item(new FabricItemSettings().rarity(Rarity.EPIC).group(AOAItemGroup.ACTS_OF_ABOVE)));
    ...
    public static final Item EYE_OF_ABOVE = registerItem("eye_of_above",
            new ColorItem(new FabricItemSettings().group(AOAItemGroup.ACTS_OF_ABOVE), 16755200));
